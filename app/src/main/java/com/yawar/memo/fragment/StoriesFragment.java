...
//        statuses.add(new Status(false,"http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4"));
//        statuses.add(new Status(false,"http://videocdn.bodybuilding.com/video/mp4/62000/62792m.mp4"));
//        statuses.add(new Status(false,"http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4"));
...
//            userStatusList.add(myUserStatus);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK && requestCode == IMAGE_PICKER_SELECT) {
            ...
            if (selectedMediaUri.toString().contains("image")) {
                ...
                myUserStatus.getStatusList().add(new Status(true, selectedMediaUri.toString(),"image"));
                myBase.getStoriesObserve().setMyStatus(myUserStatus);
